...
export class AuthorizerExampleStack extends cdk.Stack {
  constructor(
    ...
    const { environment, userPoolName, callbackUrls, logoutUrls } = props;
    ...
    const restFunctionLogs = new LogGroup(
      this,
      'AuthorizerExampleRestLambdaFunctionLogGroup',
      {
    ...
    const restFunction = new NodejsFunction(
      this,
      'AuthorizerExampleLambdaRestFunction',
      {
        ...
        role: new Role(
          this,
          'AuthorizerExampleLambdaRestFunctionExecutionRole',
          {
    ...
    const graphqlFunctionLogs = new LogGroup(
      this,
      'AuthorizerExampleLambdaGraphQLFunctionLogGroup',
      {
    ...
    const graphqlFunction = new NodejsFunction(
      ...
      'AuthorizerExampleLambdaGraphQLFunction',
      {
        ...
        role: new Role(
          this,
          'AuthorizerExampleLambdaGraphQLFunctionExecutionRole',
          {
            assumedBy: new ServicePrincipal('lambda.amazonaws.com'),
            inlinePolicies: {
              'logs-policy': new PolicyDocument({
    ...
    api.root
      .addResource('rest')
      .addMethod('ANY', new LambdaIntegration(restFunction), {
        authorizer,
      });

    api.root
      .addResource('graphql')
      .addMethod('ANY', new LambdaIntegration(graphqlFunction), {
        authorizer,
      });
